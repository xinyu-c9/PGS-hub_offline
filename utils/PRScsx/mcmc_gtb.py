        ...
        for jj in range(p_tot):
            ...
            while True:
                try:
                    ...
                    if loop_count % 1000000 == 0 and loop_count != 0:
                        print("This process may stuck in infinite loop due to gigrnd error, and you could stop this task or continue to wait. Current loop count is " + str(loop_count))
                        continue
                    else:
                        continue
                else:

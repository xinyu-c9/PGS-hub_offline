...
apply.fun = function(block.ind){
  ...
  if(file.exists(paste0(out_dir, '/tmp_files/block/ref_bim_block_', block.ind, '.txt'))){
    ...
    ref1_bed_block = data.frame(fread(paste0(out_dir, '/tmp_files/block/ref1_bed_block_', block.ind, '.txt'),check.names = FALSE),check.names = FALSE)
    ref2_bed_block = data.frame(fread(paste0(out_dir, '/tmp_files/block/ref2_bed_block_', block.ind, '.txt'),check.names = FALSE),check.names = FALSE)
